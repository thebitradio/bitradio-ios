...
class Sender {
    ...
    private func postProtocolPaymentIfNeeded() {
        ...
        request.setValue("application/bitradio-payment", forHTTPHeaderField: "Content-Type")
        request.addValue("application/bitradio-paymentack", forHTTPHeaderField: "Accept")
        ...
        URLSession.shared.dataTask(with: request as URLRequest) { data, response, error in
            ...
            if response.mimeType == "application/bitradio-paymentack" && data.count <= 50000 {
